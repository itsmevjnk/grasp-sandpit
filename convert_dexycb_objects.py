...
OUTPUT_DIR = os.environ.get('OUTPUT_DIR', 'dexycb_models')
...
for i in _YCB_CLASSES:
    ...
    INPUT_DIR = f'{DEXYCB_PATH}/models/{object_name}'
    mesh = o3d.io.read_triangle_mesh(INPUT_DIR + '/textured_simple.obj')
    ...
    texture_map = cv2.imread(INPUT_DIR + '/texture_map.png'); texture_map = cv2.cvtColor(texture_map, cv2.COLOR_BGR2RGB)
